...
<div id="search-results">
    ...
    <div class="row">
        ...
        <div class="col-xs-8 col-sm-9 col-md-10 col-lg-10 search-block">           
            <a href="<?php echo record_url($record, 'show'); ?>"><?php echo $searchText['title'] ? $searchText['title'] : __('[Unknown]'); ?></a><br>
