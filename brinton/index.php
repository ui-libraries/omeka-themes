			...
			<div class="row">
		  		...
		  		<div id="main-slider" class="flexslider">
				    ...
				    <ul class="slides">
				        ...
				        <li><a href=""><img src="themes/brinton/images/brinton_slider.png" alt="" /></a>
				        	<div class="flex-caption">
					        	<div class="details">
					        		<!-- <h1 class="flex-title"><i class="icon-star"></i><i class="icon-star"></i><i class="icon-star"></i><br /><span>The Brinton Entertainment Company</span></h1> -->					        						        		
					        	</div>
					        </div>
				        </li>			        
			...
			<div class="container">
				...
				<header class="section-heading row">
					...
					<div class="sixteen columns">
						...
						<i class="icon-star-empty icon-large"></i>
						<h1><span>Brinton's Films</span></h1>	
